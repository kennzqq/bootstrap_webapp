      ...
      <div
        ...
        <div class="flex flex-col justify-between animate-slideInLeft delay-200">
          <div>
            ...
            <div class="text-gray-700 mt-8">
              Send us an email <span class="underline"><a target="_BLANK" href="https://mail.google.com/mail/u/0/#inbox?compose=new">https://gmail.com</a></span>
            </div>
          </div>
        ...
        <div class="animate-slideInRight delay-300">
          <div>
            ...
            <label id="fullname-error" class="error text-red-500 text-sm mt-1 hidden" for="fullname"></label>
          </div>
          <div class="mt-8">
            ...
            <input id="email" name="email" class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="email" required>
            <label id="email-error" class="error text-red-500 text-sm mt-1 hidden" for="email"></label>
          </div>
          <div class="mt-8">
            ...
            <label id="message-error" class="error text-red-500 text-sm mt-1 hidden" for="message"></label>
          </div>
          <div class="mt-8">
            <button type="submit"
              class="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline hover:bg-indigo-600 transition-colors">
              Send Message
            </button>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-center">
        <div class="w-full lg:w-10/12">
          <div class="relative w-full rounded-lg overflow-hidden shadow-lg" style="aspect-ratio: 21/9;">
            <iframe
