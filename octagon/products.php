      ...
      <div class="row mb-4">
        <div class="col-12">
          <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            <div id="category-filters" class="d-flex gap-2 flex-wrap flex-grow-1"></div>
            <form class="d-flex" style="min-width: 250px; max-width: 350px;" role="search">
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content border-0 shadow">
        <div class="modal-body text-center p-4">
          ...
          <h4 class="mb-3 fw-bold">Added to Cart!</h4>
          <p class="text-muted mb-4">Item successfully added to your shopping cart</p>
          <div class="d-grid gap-2">
            <button type="button" class="btn btn-success px-4 py-2" data-bs-dismiss="modal">
              <i class="bi bi-check2 me-2"></i>Continue Shopping
            </button>
            <a href="cart.html" class="btn btn-outline-primary px-4 py-2">
